function createSuccessTestData() {
  ...
  const test1 = {
    testDescription: 'returning 2 when multiply 2 * 1', left: 2, right: 1, result: 2,
  };
  const test2 = {
    testDescription: 'returning 2 when multiply 1 * 2', left: 1, right: 2, result: 2,
  };
  const test3 = {
    testDescription: 'returning 4 when multiply 2 * 2', left: 2, right: 2, result: 4,
  };
  const test4 = {
    testDescription: 'returning -2 when multiply 2 * -1', left: 2, right: -1, result: -2,
  };
